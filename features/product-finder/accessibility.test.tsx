...
describe("accessibility (axe) — feature modals have no WCAG violations", () => {
  ...
  afterEach(() => {
    vi.unstubAllGlobals();
    useProductFinder.setState({ guidedOpen: false, rfqOpen: false, returnModalOrderId: null, bomIqOpen: false, bomModalOpen: false, cycleCountOpen: false, jobsOpen: false, kitsOpen: false, willCallOpen: false, vmiOpen: false, quickOrderOpen: false, orders: [], cart: {}, compareIds: new Set(), keyboardHelpOpen: false, results: [] });
  });
...
describe("keyboard: Escape closes the new dialogs (WCAG 2.1.2/2.4.3)", () => {
  afterEach(() => {
    vi.unstubAllGlobals();
    useProductFinder.setState({ guidedOpen: false, rfqOpen: false, returnModalOrderId: null, bomIqOpen: false, bomModalOpen: false, cycleCountOpen: false, jobsOpen: false, kitsOpen: false, willCallOpen: false, vmiOpen: false, quickOrderOpen: false, orders: [], keyboardHelpOpen: false });
  });
