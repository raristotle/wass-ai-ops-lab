...
export function SubmittalPackage({
  items, customer, project, packageNumber, dateLabel, preparedBy,
    ...
    <div className="text-[#1D252D]">
      ...
      <div className="border-b-2 border-[#1D252D] pb-6 mb-6 print:break-after-page">
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-xs font-semibold uppercase tracking-widest text-[#4F758B]">Supply Co.</span>
        </div>
      ...
      <p className="mt-6 text-[10px] italic text-[#4F758B]">
        Generated by Meridian Supply Co. Product Finder. Specifications are representative; confirm against the manufacturer&apos;s datasheet before installation.
      </p>
    </div>
  );
}
