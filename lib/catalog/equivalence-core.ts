 ...
 *
 * CLIENT-SAFE CORE: this module is deliberately taxonomy-only (no getCatalog) so
 * client components can compare two already-loaded products without dragging the
 * generated catalog into the browser bundle (docs/perf-audit-2026-07-10.md).
 * Catalog-scanning helpers (functionalEquivalents) live in equivalence.ts.
 */
