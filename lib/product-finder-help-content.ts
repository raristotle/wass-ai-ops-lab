...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  {
    id: "load-data",
    title: "Load your data — imports & samples",
    body: [
      ...
      "• Capture as you go — any product's View Details has a “+ Add Wesco stock #” field; whatever you type is saved to the crosswalk (deduped) so a search for that number resolves to the part next time. Real identifiers build up as a byproduct of daily use.",
  ...
  },
  {
    ...
    body: [
      ...
      "• Real parts rank first: when two results are equally relevant, genuine cataloged and manufacturer-verified products sort above simulated demo placeholders — so the first thing you quote is always a real SKU.",
    ],
  ...
  },
  {
    ...
    body: [
      "Click Cross-reference by the search box and paste a competitor OR your own stocked/target part number — the lookup now works in BOTH directions, so you get an answer whether the customer reads you their incumbent's number or their spec sheet.",
